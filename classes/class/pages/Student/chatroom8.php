  ...
  <div class ="outer">
    ...
    <select name = 'recipient'>
          <option selected disabled>[Select recipient]</option>
                                      ...
                                      $sqlemail = "SELECT * FROM `ihs_user_permissions` WHERE permissions LIKE '%grade_8%'";
...
<?php
$sqlchat ="SELECT DISTINCT(chat_id) FROM chats8";
...
if(isset($_POST['chat'])){
  ...
  # All chats
  $sql2a ="SELECT * FROM chats8 WHERE chat_id = '$chatid' AND (recipient_mail = '$email' || recipient_mail = 'All' || created_by_email = '$email')";
