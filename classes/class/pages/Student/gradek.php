...
<div class ="row">
	<div class ="col-5 container">
		<div>
			<h5 class ="header">Click for: <a href ='gradekassignments.php'>Assignments & Projects</a></h5>
...
$sqltimetable ="SELECT * FROM ihs_timetable_uploads WHERE grade = 'gradek' ORDER BY created_at DESC LIMIT 1";
...
<div class ="container">
		<h5 class ="header"><a href ='chatroomk.php'>Chat Room / Discussion Forums</a></h5>
		<h5 class ="header"><a href =' https://us02web.zoom.us/j/89411201821'>Live web conference - Bonne Terre Meet</a></h5>
</div>
