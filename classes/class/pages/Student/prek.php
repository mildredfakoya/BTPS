...
<div class ="row">
	<div class ="col-5 container">
		<div>
			<h5 class ="header">Click for: <a href ='prekassignments.php'>Assignments & Projects</a></h5>
...
$sqltimetable ="SELECT * FROM ihs_timetable_uploads WHERE grade = 'prek' ORDER BY created_at DESC LIMIT 1";
...
<div class ="container">
		<h5 class ="header"><a href ='chatroomprek.php'>Chat Room / Discussion Forums</a></h5>
