...
<div class ="row">
	<div class ="col-5 container">
		<div>
			<h5 class ="header">Click for: <a href ='grade10assignments.php'>Assignments & Projects</a></h5>
			<h5 class ="header">Click for: <a href ='grade10continous.php'>Continous Assessments</a></h5>
			<h5 class ="header">Click for: <a href ='grade10exams.php'>Examination</a></h5>
			<h5 class ="header">Click for: <a href ='feedback10.php'>Grades and Feed back</a></h5>
			<h5 class ="header">Click for: <a href ='library.php'>Electronic Library</a></h5>
			<h5 class ="header">Click for: <a href ='studyguide10.php'>Study Guide</a></h5>
		</div>
...
$sqltimetable ="SELECT * FROM ihs_timetable_uploads WHERE grade = 'grade10' ORDER BY created_at DESC LIMIT 1";
...
<div class ="container">
		<h5 class ="header"><a href ='chatroom10.php'>Chat Room / Discussion Forums</a></h5>
		<h5 class ="header"><a href =' https://us02web.zoom.us/j/87538373793'>Live web conference - Bonne Terre Meet</a></h5>
</div>
