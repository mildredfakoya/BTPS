...
<div class ="row">
	<div class ="col-5 container">
		<div>
			<h5 class ="header">Click for: <a href ='grade3assignments.php'>Assignments & Projects</a></h5>
			<h5 class ="header">Click for: <a href ='grade3continous.php'>Continous Assessments</a></h5>
			<h5 class ="header">Click for: <a href ='grade3exams.php'>Examination</a></h5>
			<h5 class ="header">Click for: <a href ='feedback3.php'>Grades and Feed back</a></h5>
			<h5 class ="header">Click for: <a href ='library.php'>Electronic Library</a></h5>
			<h5 class ="header">Click for: <a href ='studyguide3.php'>Study Guide</a></h5>
		</div>
...
$sqltimetable ="SELECT * FROM ihs_timetable_uploads WHERE grade = 'grade3' ORDER BY created_at DESC LIMIT 1";
...
<div class ="container">
		<h5 class ="header"><a href ='chatroom3.php'>Chat Room / Discussion Forums</a></h5>
		<h5 class ="header"><a href ='https://us02web.zoom.us/j/81949720715'>Live web conference - Bonne Terre Meet</a></h5>
</div>
