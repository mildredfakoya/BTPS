...
$releaseassignments = "SELECT DISTINCT assessment_id FROM btps_student_exam_grade_5 WHERE email = :email AND visibility = 'Visible'";
...
$releaseassignments = "SELECT DISTINCT assessment_id FROM btps_student_continous_grade_5 WHERE email = :email AND visibility = 'Visible'";
$stmtreleaseassignment = $user_home->runQuery($releaseassignments);
$stmtreleaseassignment->bindValue(':email', $email);
$stmtreleaseassignment->execute();
foreach($stmtreleaseassignment as $getid){
...
$releaseassignments = "SELECT DISTINCT assessment_id FROM btps_student_assignment_grade_5 WHERE email = :email AND visibility = 'Visible'";
$stmtreleaseassignment = $user_home->runQuery($releaseassignments);
$stmtreleaseassignment->bindValue(':email', $email);
$stmtreleaseassignment->execute();
foreach($stmtreleaseassignment as $getid){
