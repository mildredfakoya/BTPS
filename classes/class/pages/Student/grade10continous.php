...
<h5 class ="header">Continous Assessment</h5>
  ...
  <?php
    ...
    $sqlclass="SELECT * FROM btps_new_assessment WHERE target_class= :class and assessment_type = 'continous_assessment' and approval_status ='Approved' AND term =:term AND academic_year = :year AND access_status = 'UNLOCKED'" ;
    ...
    foreach($stmtclass as $rowclass){
      ...
      if($diffdate <= 0){
      echo "<form method ='post' action ='grade10continousform.php' id ='getassignment' novalidate = 'novalidate'>";
      echo "<div class ='row'>";
  ...
  $sqlcheck= "SELECT DISTINCT assessment_id FROM btps_student_continous_grade_10 WHERE email = :email";
