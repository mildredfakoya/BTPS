...
<div class ="jumbotron">
<div class ="header" style ="background-color:#ff0000"><h3>Welcome to Grade 5 Graded Assessment page</h3>
...
<h5 class ="header">Continous Assessment</h5>
  ...
  <?php
    $targetclass = "grade_5";
    $sqlclass="SELECT * FROM btps_new_assessment WHERE target_class= :class and assessment_type = 'continous_assessment' AND term =:term AND academic_year = :year AND approval_status ='Approved' AND access_status = 'UNLOCKED'" ;
    ...
    foreach($stmtclass as $rowclass){
      ...
      if($diffdate <= 0){
      echo "<form method ='post' action ='grade5continousform.php' id ='getassignment' novalidate = 'novalidate'>";
      echo "<div class ='row'>";
  ...
  $sqlcheck= "SELECT DISTINCT assessment_id FROM btps_student_continous_grade_5 WHERE email = :email";
