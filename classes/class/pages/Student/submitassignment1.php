...
for($i=0;$i<count($questionid);$i++)
{
  ...
  $sqlcheck = "SELECT * FROM btps_student_assignment_grade_1 WHERE question_id = '$questionid[$i]'";
...
try{
  $sqlmultichoice= "UPDATE btps_student_assignment_grade_1 SET submitted_at ='$submittedat', student_answer ='$studentanswer[$i]' WHERE question_id = '$questionid[$i]'";
