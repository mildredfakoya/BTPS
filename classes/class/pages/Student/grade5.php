...
if(!in_array("grade_5", $permissions)){
...
<div class ="row">
	<div class ="col-5 container">
		<div>
			<h5 class ="header">Click for: <a href ='grade5assignments.php'>Assignments & Projects</a></h5>
			<h5 class ="header">Click for: <a href ='grade5continous.php'>Continous Assessments</a></h5>
			<h5 class ="header">Click for: <a href ='grade5exams.php'>Examination</a></h5>
			<h5 class ="header">Click for: <a href ='feedback5.php'>Grades and Feed back</a></h5>
			<h5 class ="header">Click for: <a href ='library.php'>Electronic Library</a></h5>
			<h5 class ="header">Click for: <a href ='studyguide5.php'>Study Guide</a></h5>
		</div>
...
$sqltimetable ="SELECT * FROM ihs_timetable_uploads WHERE grade = 'grade5' ORDER BY created_at DESC LIMIT 1";
...
<div class ="container">
		<h5 class ="header"><a href ='chatroom5.php'>Chat Room / Discussion Forums</a></h5>
		<h5 class ="header"><a href ='https://us02web.zoom.us/j/89034591111'>Live web conference - Bonne Terre Meet</a></h5>
</div>
