...
<div class ="jumbotron">
<div class ="header" style ="background-color:#ff0000"><h3>Welcome to Grade 8 Graded Assessment page</h3>
...
<h5 class ="header">Continous Assessment</h5>
  ...
  <?php
    ...
    foreach($stmtclass as $rowclass){
      ...
      if($diffdate <= 0){
      echo "<form method ='post' action ='grade8continousform.php' id ='getassignment' novalidate = 'novalidate'>";
      echo "<div class ='row'>";
  ...
  $sqlcheck= "SELECT DISTINCT assessment_id FROM btps_student_continous_grade_8 WHERE email = :email";
