...
if(!in_array("assessment", $permissions) OR !in_array("grade_6_teacher", $permissions)){
...
if($assessmenttype == 'exam'){
  $sqlreview= "SELECT * FROM btps_student_exam_grade_6 WHERE assessment_id = '$assessmentid' ORDER BY question_id";
...
if($assessmenttype == 'continous_assessment'){
  $sqlreview= "SELECT * FROM btps_student_continous_grade_6 WHERE assessment_id = '$assessmentid' ORDER BY question_id";
  $stmtreview = $user_home->runQuery($sqlreview);
  $stmtreview->execute();
...
if($assessmenttype == 'assignment' OR $assessmenttype == 'project'){
  $sqlreview= "SELECT * FROM btps_student_assignment_grade_6 WHERE assessment_id = '$assessmentid' ORDER BY question_id";
  $stmtreview = $user_home->runQuery($sqlreview);
  $stmtreview->execute();
