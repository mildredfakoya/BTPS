...
$sqltopic = "SELECT * FROM btps_multichoice WHERE question_id = :id";
...
if(isset($_POST['deletemulti'])){
  ...
  try{
      $sql = "DELETE FROM btps_multichoice WHERE question_id='$questionid'";
...
Option 1: <input type = "text" name = "option1" value ="<?php echo $rowtopic['option1'] ?>"/><br/><br/>
Option 2:<input type = "text" name = "option2" value ="<?php echo $rowtopic['option2'] ?>"><br/><br/>
Option 3:<input type = "text" name = "option3" value ="<?php echo $rowtopic['option3'] ?>"><br/><br/>
Option 4:<input type = "text" name = "option4" value ="<?php echo $rowtopic['option4'] ?>"><br/><br/>
