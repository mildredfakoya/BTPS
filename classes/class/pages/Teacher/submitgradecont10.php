...
$email = $_POST['hidden'];
$score = $_POST['points'];
$assessmenttype ='Continous_assessment';
$class ='Grade 10';
$subject = $_POST['subject'];
for($i=0;$i<count($score);$i++)
{
  try{
    $sqlmultichoice= "UPDATE btps_student_continous_grade_10 SET score = '$score[$i]' WHERE question_id = '$questionid[$i]' AND email ='$email'";
